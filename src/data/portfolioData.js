...
export const portfolioData = {
  personal: {
    ...
    summary: "Detail-oriented React Native Developer with 4+ years of experience in building scalable, performant, and intuitive mobile applications. Skilled in cross-functional collaboration, rapid prototyping, and delivering high-quality apps under tight deadlines."
  },
  experience: [
    {
  ...
  projects: [
    {
      ...
      skills: ["Bitcoin", "React-Native", "NodeJS", "Redux-Saga", "RealmDB", "Push Notifications", "NFC", "FastLane CI/CD"],
      description: "Bitcoin Keeper is a self-custodial wallet focused on empowering users with secure and intuitive Bitcoin management. It's a self-custody Bitcoin wallet with collaborative recovery features, built on Bitcoin ethos, industrial standards, and cutting-edge UX.",
      achievements: [
    ...
    },
    {
      ...
      name: "AthesAI",
      platform: "Android & iOS",
      skills: ["React Navigation", "Zustand", "Push Notifications", "React Native FFMPEG", "SSE", "React Native FS", "MixPanel"],
      description: "This app delivers curated sports and skills-based videos to athletes and an AI-powered chatbot that offers personalized assistance and insights tailored to individual sports interests.",
      achievements: [
    ...
    },
    {
      ...
      name: "HypeX",
      platform: "iOS",
      skills: ["React Navigation", "Redux", "Thunk", "Apple Maps", "React Native Vision Camera"],
      description: "A social media application, reminiscent of Instagram, encompasses the following key features:",
      achievements: [
    ...
    },
    {
      ...
      description: "A simple application that takes gender, age, height, and weight as input to calculate Body Mass Index(BMI) and suggest a workout schedule to maintain the BMI if it exceeds the normal range.",
      links: [
        {
  ...
  achievements: [
    ...
    },
    {
      ...
      description: "For exceptional delivery of the HypeX app. Available on Apple app store.",
      company: "Valere Labs",
      period: "2023"
    }
  ],
  ...
  certifications: [
    ...
    },
    {
      ...
      coordinator: "Dr. Pavan Kumar Mishra, Dr. Saikat Majumdar, Dr. Rakesh Tripathi",
      platform: "NIT, Raipur",
